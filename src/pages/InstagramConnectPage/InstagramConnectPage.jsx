...
const InstagramConnectPage = () => {
  ...
  const handleConnectInstagramBasic = async () => {
    try {
      ...
      const url = buildInstagramBasicLoginUrl({ state });
      console.log('🔗 Basic Instagram Login URL:', url);
      window.location.href = url;
    } catch (e) {
      console.error('Unable to start Basic Instagram Login:', e);
          ...
          >
            {loading ? (
              ...
              <>
                ...
                Connect Instagram Account (Full Access)
              </>
            )}
          </button>
